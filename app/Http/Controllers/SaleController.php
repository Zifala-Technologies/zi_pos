...
class SaleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($role->hasPermissionTo('sales-index')) {
            ...
            return view('backend.sale.index', compact('starting_date', 'ending_date', 'warehouse_id', 'sale_status', 'payment_status', 'lims_gift_card_list', 'lims_pos_setting_data', 'lims_reward_point_setting_data', 'lims_account_list', 'lims_warehouse_list', 'all_permission', 'options'));
        } else {
    ...
    public function create()
    {
        ...
        if ($role->hasPermissionTo('sales-add')) {
            ...
            return view('backend.sale.create', compact('lims_customer_list', 'lims_warehouse_list', 'lims_biller_list', 'lims_pos_setting_data', 'lims_tax_list', 'lims_reward_point_setting_data', 'options'));
        } else {
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($data['payment_status'] == 3 || $data['payment_status'] == 4 || ($data['payment_status'] == 2 && $data['pos'] && $data['paid_amount'] > 0)) {
            ...
            if ($data['paid_by_id'] == 1) {
                ...
                $paying_method = 'eDahab';
            } elseif ($data['paid_by_id'] == 4) {
                $paying_method = 'Premier Wallet';
    ...
    public function createSale($id)
    {
        ...
        if ($role->hasPermissionTo('sales-edit')) {
            ...
            return view('backend.sale.create_sale', compact('lims_biller_list', 'lims_customer_list', 'lims_warehouse_list', 'lims_tax_list', 'lims_sale_data', 'lims_product_sale_data', 'lims_pos_setting_data', 'lims_brand_list', 'lims_category_list', 'lims_coupon_list', 'lims_product_list', 'product_number', 'lims_customer_group_all', 'lims_reward_point_setting_data'));
        } else {
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
        }
    }
    ...
    public function genInvoice($id)
    {
        ...
        $lims_pos_setting_data = PosSetting::select('invoice_option', 'invoice_info', "invoice_info_footer", "printer_one_category_id", "printer_two_category_id", "printer_three_category_id")->latest()->first();
        ...
        if ($lims_pos_setting_data->invoice_option == 'A4') {
            return view('backend.sale.a4_invoice', compact('lims_sale_data', 'lims_product_sale_data', 'lims_biller_data', 'lims_warehouse_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords', 'paid_by_info'));
        } else {
            return view('backend.sale.invoice', compact('lims_sale_data', 'lims_product_sale_data', 'lims_biller_data', 'lims_warehouse_data', 'lims_customer_data', 'lims_payment_data', 'lims_pos_setting_data', 'numberInWords', 'cat_one', 'cat_two', 'cat_three'));
        }
    }
