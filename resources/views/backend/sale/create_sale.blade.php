                            ...
                            @if ($supplier_due_report_active)
                                <li id="supplier-due-report-menu">
                                    ...
                                    <input type="hidden" name="start_date"
                                        value="{{ date('Y-m-d', strtotime('-1 year')) }}" />
                                    <input type="hidden" name="end_date" value="{{ date('Y-m-d') }}" />
                                    <a id="supplier-due-report-link"
                                        href="">{{ trans('file.Supplier Due Report') }}</a>
                                    {!! Form::close() !!}
                                </li>
                            @endif
                        </ul>
                                                    ...
                                                    @foreach ($lims_product_sale_data as $product_sale)
                                                        <tr>
                                                            ...
                                                            <td class="col-sm-2 product-title">
                                                                ...
                                                                [{{ $product_data->code }}] <button type="button"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <span class="totals-title">{{ trans('file.Items') }}</span><span
                                                    id="item">{{ $lims_sale_data->item }}
                                                    ({{ $lims_sale_data->total_qty }})</span>
                                            </div>
                                            <div class="col-sm-4">
                                                <span class="totals-title">{{ trans('file.Total') }}</span><span
                                                    id="subtotal">{{ number_format((float) $lims_sale_data->total_price, 2, '.', '') }}</span>
                                            </div>
                                            <div class="col-sm-4">
                                                ...
                                                @else
                                                    <span
                                                        id="discount">{{ number_format(0, $general_setting->decimal, '.', '') }}</span>
                                                @endif
                                            </div>
                                            <div class="col-sm-4">
                                                ...
                                                @if ($lims_sale_data->coupon_discount)
                                                    <span
                                                        id="coupon-text">{{ number_format((float) $lims_sale_data->coupon_discount, 2, '.', '') }}</span>
                                                @else
                                                    <span
                                                        id="coupon-text">{{ number_format(0, $general_setting->decimal, '.', '') }}</span>
                                                @endif
                                            </div>
                                            <div class="col-sm-4">
                                                ...
                                                @else
                                                    <span
                                                        id="tax">{{ number_format(0, $general_setting->decimal, '.', '') }}</span>
                                                @endif
                                            </div>
                                            <div class="col-sm-4">
                                                ...
                                                @if ($lims_sale_data->shipping_cost)
                                                    <span
                                                        id="shipping-cost">{{ number_format((float) $lims_sale_data->shipping_cost, 2, '.', '') }}</span>
                                                @else
                                                    <span
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-1">
                                                ...
                                                <!-- @php
                                                    $options = explode(',', $lims_pos_setting_data->payment_options);
                                                @endphp -->
                                                <select class="form-control selectpicker payment-option">
                                                    @if (in_array('cash', $options))
                                        ...
                                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                            ...
                                            @if ($pos_setting_permission_active)
                                                <li class="nav-item"><a class="dropdown-item"
                                                        href="{{ route('setting.pos') }}"><i class="dripicons-gear"></i>
                                                ...
                                                <li class="nav-item">
                                                    <a rel="nofollow" data-target="#" href="#"
                                                        ...
                                                        class="nav-link dropdown-item"><i class="dripicons-bell"></i><span
                                                            class="badge badge-danger">{{ $alert_product }}</span>
                                                    ...
                                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications"
                                                        ...
                                                        <li class="notifications">
                                                            <a href="{{ route('report.qtyAlert') }}"
                                                                class="btn btn-link">{{ $alert_product }} product exceeds
                                                                alert quantity</a>
                                                        </li>
                                                    </ul>
                                                </li>
                    ...
                    if ($("#coupon-code").val() == value['code']) {
                        ...
                        if (parseFloat(value['quantity']) <= parseFloat(value['used']))
                            ...
                            if (parseFloat($('input[name="grand_total"]').val()) >= value['minimum_amount']) {
                                ...
                                $('#coupon-text').text(parseFloat(value['amount']).toFixed(
                                    {{ $general_setting->decimal }}));
