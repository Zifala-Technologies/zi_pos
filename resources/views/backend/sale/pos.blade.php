                        ...
                        <div class="payment-options">
                            ...
                            @if (in_array('evc', $options))
                                <div class="column-5">
                                    <button style="background: #00cec9" type="button"
                                        class="btn btn-sm btn-custom payment-btn" data-toggle="modal"
                                        data-target="#add-payment" id="evc-btn"><i class="fa fa-money"></i>
...
@push('scripts')
    <script type="text/javascript">
        ...
        function creditCard() {
            @if (strlen($lims_pos_setting_data->stripe_public_key) > 0 && strlen($lims_pos_setting_data->stripe_secret_key) > 0)
